...
int main(int argc, char *argv[])
{
    ...
    api->fillSegment("/mnt/Data/git/image_marker/test_images/image.4.jpg", 59, 82, 2);
    std::cout << "fillSegment finished" << std::endl;
    //api->fillSegment("/mnt/Data/git/image_marker/test_images/image.2.jpg", 10, 11, 1);
    //std::cout << "fillSegment finished" << std::endl;
    //api->fillAllUnlabeledSegments("/mnt/Data/git/image_marker/test_images/image.1.jpg", 4);
